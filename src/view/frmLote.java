...
public class frmLote extends javax.swing.JFrame {
    ...
    public frmLote() {
        ...
        tblLote.getColumnModel().getColumn(0).setPreferredWidth(170);
        tblLote.getColumnModel().getColumn(1).setPreferredWidth(130);
        tblLote.getColumnModel().getColumn(2).setPreferredWidth(20);
        setIcon();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Produto por lote");
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        for (int i = 0; i < tblLote.getRowCount(); i++) {
            boolean estado = (boolean) tblLote.getModel().getValueAt(i, 2);
            String prod = tblLote.getModel().getValueAt(i, 0).toString();
            String local = tblLote.getModel().getValueAt(i, 1).toString();
            if (estado == true) {
                executar(prod, local);
            }
        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if (txtLocal.getText().isEmpty() == false) {
            DefaultTableModel modelo = (DefaultTableModel) tblLote.getModel();
            modelo.setNumRows(0);
            for (Iterator<Leitor> it = dao.selectLote(txtLocal.getText(), txtAte.getText()).iterator(); it.hasNext();) {
                leia = it.next();
    ...
    private void executar(String p, String l) {
        try {
            Barcode barcode = BarcodeFactory.createCode128(p);
            ...
            QrCode qr = QrCode.encodeText(l.trim(), errCorLvl);
            lbl = new JLabel(CriarCodigo.criarImagem(barcode, l.trim(), qr.toImage(2, 0)));
            pan.add(lbl);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmLote.class
